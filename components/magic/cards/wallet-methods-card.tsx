...
import GetIdToken from '../wallet-methods/get-id-token';
import GetMetadata from '../wallet-methods/get-metadata';
...
import UpdateEmail from '../wallet-methods/update-email'
